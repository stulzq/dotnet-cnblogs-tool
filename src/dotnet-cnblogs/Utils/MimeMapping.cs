...
namespace Dotnetcnblog.Utils
{
    ...
    {
        private static readonly Hashtable MimeMappingTable;

        static MimeMapping()
        {
            MimeMappingTable = new Hashtable(190, StringComparer.CurrentCultureIgnoreCase);
        ...
        {
            MimeMappingTable.Add(extension, mimeType);
        }
        ...
        public static string GetMimeMapping(string fileName)
        {
            ...
            if (0 < num && num > fileName.LastIndexOf('\\')) text = (string) MimeMappingTable[fileName.Substring(num)];
            if (text == null) text = (string) MimeMappingTable[".*"];
            return text;
        }
    }
}